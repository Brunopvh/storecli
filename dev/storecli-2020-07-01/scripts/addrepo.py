...
class AddRepo:
	...
	def __init__(self):
		...
		self.os_codename = OsInfo.get_codename()
	...
	def debian(self):
		...
		debianRepoMain = str((f'deb http://deb.debian.org/debian {self.os_codename} main'))
		debianRepoContrib = str((f'deb http://deb.debian.org/debian {self.os_codename} contrib'))
		debianRepoNonfree = str((f'deb http://deb.debian.org/debian {self.os_codename} non-free'))
		debianMainContribNonfree = str((f'deb http://deb.debian.org/debian {self.os_codename} main contrib non-free'))
