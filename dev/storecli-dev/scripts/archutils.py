...
#              https://raw.github.com/Brunopvh/storecli/master/setup.sh
...
class ArchUtiuls:
	...
	def install_grub(self):
		...
		elif 'gpt' in self.get_table_info():
